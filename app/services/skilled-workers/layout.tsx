...
export const metadata: Metadata = {
  ...
  description: 'Qualifizierte Fachkräfte für Ingenieurwesen, IT und Pflege. Anerkannte Abschlüsse, rechtssicher nach §18a/b AufenthG. Sofort einsatzbereit.',
  openGraph: {
    title: 'Fachkräfte aus Vietnam vermitteln | DMF Manpower',
...
export default function SkilledWorkersLayout({
  children,
}: {
