...
export const metadata: Metadata = {
  ...
  description: 'Unsere Top-Talente: Qualifizierte Fachkräfte aus Vietnam, die sẵn sàng làm việc. Alle Kandidaten haben ihre Qualifikationen bestätigt und sind visa-ready.',
  keywords: [
    'Kandidaten Pool',
    'Fachkräfte Vietnam',
    'Bewerber Pool',
...
export default function KandidatenLayout({
  children,
}: {
