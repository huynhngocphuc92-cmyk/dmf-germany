    ...
    <section className={`py-20 ${currentTheme.bg}`}>
      <div className="container max-w-4xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <span
            className={`inline-flex items-center justify-center px-4 py-1 rounded-full text-sm font-bold mb-4 ${currentTheme.icon} ${currentTheme.text}`}
          >
        ...
        <div className="space-y-4">
          {items.map((item, idx) => (
            ...
            >
              ...
              >
                <span
                  className={`font-bold text-lg ${openIndex === idx ? currentTheme.text : "text-slate-700"}`}
                >
                  {item.question}
                </span>
                <ChevronDown
