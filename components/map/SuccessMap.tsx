...
// Use inline base64 to avoid any network, CDN, or build-time asset resolution issues
...
// Create custom icon safely to avoid Next.js SSR build crashes
    ...
    <div className="w-full h-[600px] md:h-[80vh] rounded-lg overflow-hidden shadow-lg border border-gray-200">
      ...
      >
        ...
        {successStories.map((city: CityPlacement) => (
          <Marker key={city.id} position={city.position} icon={DefaultIcon || undefined}>
            <Popup>
